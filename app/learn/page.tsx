  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6 p-4 lg:p-6">
        {/* SIDEBAR */}
        <div className={`${sidebarOpen ? 'w-full lg:w-80' : 'w-0'} transition-all duration-300 bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden lg:sticky lg:top-6 lg:h-fit`}>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 border-t border-gray-200">
              <div className="flex flex-col lg:flex-row lg:items-start justify-between mb-4 gap-4">
                <div className="flex-1">
                  <h2 className="text-lg lg:text-xl font-bold text-gray-900 mb-1">{lesson.title}</h2>
                ...
                <div className="flex items-center gap-3">
                  {module.type === 'video' ? (
                    <button
                      ...
                      className={`px-4 lg:px-6 py-2 lg:py-3 rounded-xl font-semibold transition-all duration-200 text-sm lg:text-base ${
                        moduleCompleted
                          ? 'bg-green-600 text-white hover:bg-green-700 shadow-lg'
                          : 'bg-gray-200 text-gray-500 cursor-not-allowed'
                      }`}
                    >
                      {moduleCompleted ? '✓ Complete' : 'Watch to continue'}
                    </button>
                  ) : (
                    <div className="text-xs lg:text-sm text-gray-600 bg-blue-50 px-3 lg:px-4 py-2 rounded-lg">
                      📖 View PDF to complete
                    </div>
                  )}
                </div>
              </div>
